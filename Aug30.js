...
const elementIsAString = array =>
  array.filter(e => typeof e === typeof "string")
const elementIsANum = array => array.filter(e => typeof e !== typeof "string")
...
console.log("find the string element(s)", elementIsAString(numberArray)) // => ["a"]
