...
describe("test doPointsOverlap", () => {
    ...
    it("[false, false, false, false] should return true", () =>
        assert.deepStrictEqual(doPointsOverlap([false, false, false, false]), true)
    )
    ...
    it("[null, null, null, null] should return true", () =>
        assert.deepStrictEqual(doPointsOverlap([null, null, null, null]), true)
    )
    it("[0, 0, 0, 0] should return true", () =>
        assert.deepStrictEqual(doPointsOverlap([0, 0, 0, 0]), true)
    )
    it("[Infinity, Infinity, Infinity, Infinity] should return true", () =>
