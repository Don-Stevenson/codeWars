...
console.log(`With 14.57 million people in ontario, and approx 456.976 million license plates possible given our current format. 
Each person can own max of ${Math.round(
