...
console.log(`With 14.57 million people in Ontario, and with approx 456.976 million license plates possible
(given our current format), each person currently in Ontario own max of ${Math.round(
